      ...
      <div class = "bill-divider-wrapper">
        ...
        <div class = "bill-inputs">
          <form id = "bill-divider-form">
            <div class = "form-group">
              <label for = "subtotal">subtotal bill (&#8377;/&pound;/&euro;)</label>
        ...
        <div class = "bill-output">
          <div class = "text-group">
            <h3>Total Bill</h3>
            <span id = "total-bill">Rs 00.00</span>
          </div>

          <div class = "text-group">
            <h3>Bill Per Person</h3>
            <span id = "bill-per-person">Rs 00.00</span>
          </div>

          <div class = "text-group">
            <h3>Total Tip</h3>
            <span id = "total-tip">Rs 00.00</span>
          </div>

          <div class = "text-group">
            <h3>Tip Per Person</h3>
            <span id = "tip-per-person">Rs 00.00</span>
          </div>
        </div>
      </div>
    </div>
